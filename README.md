...
- Distribute ALGO from one wallet to all others with a single command- Send ALGO to any address- Batch send from all wallets to one address
### Token Operations (ASA)
- Create your own Algorand Standard Asset with custom name, unit, supply, and decimals- Opt wallets into any ASA- Transfer tokens between wallets or to external addresses- View token details and holdings

### Smart Contract Interaction
- Call any smart contract method with ABI encoding- Read global state from any app
